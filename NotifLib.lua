...
NotifHolder.Size = UDim2.new(0.996, 0, 1, 0)
...
function Library:Notify(Text,Timer,Properties)
	...
	if #Properties > 0 then
		for property, v in next,Properties do
			Frame[property] = v
		end
	end
	...
	task.wait(Timer)
	TextLabel.Text = ""
	local finishtween = TweenService:Create(Frame,TweenInfo.new(.3,Enum.EasingStyle.Linear,Enum.EasingDirection.Out,0,false,0),{Size = UDim2.new(0,0,0,29)}):Play()
