...
switch.Name = "Switch"
switch.BackgroundColor3 = Color3.fromRGB(28, 28, 30)
switch.BorderSizePixel = 0
switch.Size = UDim2.fromOffset(283, 28)

local uICorner5 = Instance.new("UICorner")
uICorner5.Name = "UICorner"
uICorner5.CornerRadius = UDim.new(0, 3)
uICorner5.Parent = switch

local switchText = Instance.new("TextLabel")
switchText.Name = "SwitchText"
switchText.Font = Enum.Font.GothamBold
switchText.Text = Info.Text
switchText.TextColor3 = Color3.fromRGB(235, 235, 235)
...
switchText.Position = UDim2.fromScale(0.0323, 0)
switchText.Size = UDim2.fromOffset(273, 28)
...
frame2.Position = UDim2.fromScale(0.845, 0.429)
frame2.Size = UDim2.fromOffset(26, 4)

local frame3 = Instance.new("ImageLabel")
frame3.Name = "Frame"
frame3.Image = "rbxassetid://3570695787"
frame3.ImageColor3 = Color3.fromRGB(33, 148, 255)
frame3.ScaleType = Enum.ScaleType.Slice
frame3.SliceCenter = Rect.new(100, 100, 100, 100)
frame3.BackgroundColor3 = Color3.fromRGB(33, 148, 255)
frame3.BackgroundTransparency = 1
frame3.Position = UDim2.fromScale(0, -0.75)
...
textButton2.Size = UDim2.fromOffset(10, 10)
textButton2.Parent = frame3

frame3.Parent = frame2

frame2.Parent = switch

switch.Parent = scrollingFrame1
...
local enabled = false
			textButton2.InputBegan:Connect(function(Input)
				if Input.UserInputType == Enum.UserInputType.MouseButton1 then
					...
					if enabled then
                        local color1tween = game:GetService("TweenService"):Create(frame2, TweenInfo.new(.12), {ImageColor3 = Color3.fromRGB(33, 148, 255)})
                        local color2tween = game:GetService("TweenService"):Create(frame3, TweenInfo.new(.12), {ImageColor3 = Color3.fromRGB(255,255,255)})
						local positiontween = game:GetService("TweenService"):Create(frame3, TweenInfo.new(.12), {Position = UDim2.new(0.615, 0,-0.75, 0)})
						positiontween:Play()
                        color1tween:Play()
                        color1tween:Play()
					else
                        local color1tween = game:GetService("TweenService"):Create(frame2, TweenInfo.new(.12), {ImageColor3 = Color3.fromRGB(255,255,255)})
                        local color2tween = game:GetService("TweenService"):Create(frame3, TweenInfo.new(.12), {ImageColor3 = Color3.fromRGB(33, 148, 255)})
						local positiontween = game:GetService("TweenService"):Create(frame3, TweenInfo.new(.12), {Position = UDim2.new(0, 0,-0.75, 0)})
						positiontween:Play()
                        color1tween:Play()
                        color2tween:Play()
					end
